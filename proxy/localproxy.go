...
func (listener *eventLisnter) OnStreamStart(message *aws.Message) error {
...
func (listener *eventLisnter) OnStreamReset(message *aws.Message) {

	listener.localProxy.socketManager.StopSocket(message.StreamId)
}

// OnSessionReset Refer to AWSMeesageListener.OnSessionReset
func (listener *eventLisnter) OnSessionReset(message *aws.Message) {

	listener.localProxy.socketManager.StopAll()
}

// OnData Refer to AWSMeesageListener.OnData
func (listener *eventLisnter) OnData(message *aws.Message) error {
